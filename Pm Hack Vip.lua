...
gg.alert("👑📝 ᑭᗰ ᕼᗩᑕK OᑎᒪIᑎᗴ ᑎOT 📝👑\n━━━━━━━━━━━━━━━━━━━━━\nMain Hesaba Girmeden Önce Guest Hesapta Test Ediniz. \nANTİBAN GÜNCELLENDİ 18/08/2021\n━━━━━━━━━━━━━━━━━━━━━\nGLOBAL TEST EDİLDİ ⏳\nKORE TEST EDİLDİ ⏳ \nVİETNAM TEST EDİLDİ ⏳\nTAİWAN TEST EDİLDİ⏳\nBGMI TEST EDİLDİ ⌛\n━━━━━━━━━━━━━━━━━━━━━\n@PmHackVip")


gg.alert(os.date(" ●▬▬▬▬▬๑۩Ⓥ︎Ⓘ︎Ⓟ︎۩๑▬▬▬▬▬● \n \n                 ⚜️ ᎻϴՏ̧ᏀᎬᏞᎠİΝ ⚜️ \n \n               🛑 ᑭᗰ ᐯIᑭ ՏᑕᖇIᑭT 🛑 \n \n             ❮ Tᴀʀɪʜ : %d/%m/%Y 🗓️❯\n\n●▬▬▬▬▬๑۩Ⓥ︎Ⓘ︎Ⓟ︎۩๑▬▬▬▬▬●"))
...
gg.clearResults()
  ...
  gg.searchNumber("92,893,794", nil, nil, nil, nil, nil)
  gg.getResults(50000)
  gg.editAll("67,175,681", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("67110146;67111434", nil, nil, nil, nil, nil)
  ...
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("134402", nil, nil, nil, nil, nil)
  gg.getResults(11082001)
  gg.editAll("67,175,681", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("393984", nil, nil, nil, nil, nil)
  gg.refineNumber("393984")
  gg.getResults(200000)
  gg.editAll("67,175,681", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("238592", nil, nil, nil, nil, nil)
  ...
  gg.clearResults()
  gg.setRanges(gg.REGION_CODE_APP)
  gg.searchNumber("144387;918016", nil, nil, nil, nil, nil)
  gg.refineNumber("144387")
  gg.getResults(50000)
  gg.editAll("67,175,681", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_CODE_APP)
  gg.searchNumber("92,756,535", nil, nil, nil, nil, nil)
  gg.getResults(50000)
  gg.editAll("135682", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  ...
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("67633927;67109377", gg.TYPE_DWORD, nil, nil, nil, nil)
  gg.refineNumber("67633927;67109377", gg.TYPE_DWORD)
  gg.getResults(50000)
  gg.editAll("67633927", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("67109390;67114093", gg.TYPE_DWORD, nil, nil, nil, nil)
  ...
  gg.clearResults()
  gg.setRanges(gg.REGION_CODE_APP)
  gg.searchNumber("1717633139", nil, nil, nil, nil, nil)
  gg.getResults(5000)
  gg.editAll("0", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_CODE_APP)
  gg.searchNumber("1717920863", nil, nil, nil, nil, nil)
  gg.getResults(5000)
  gg.editAll("0", gg.TYPE_DWORD)
  gg.sleep(1000)
  gg.clearResults()
  gg.clearList()
    ...
    gg.setVisible(false)
gg["setRanges"](4)
gg["searchNumber"]("134,146", 4)
revert = gg["getResults"](1000)
for i, i in ipairs((gg["getResults"](1000))) do
if i.flags == 4 then
i.value = "84149249"
i.freeze = true
end
...
os.remove("src/main/java/com/google/errorprone/annotations/concurrent")
os.remove("third_party.java_src.error_prone.project.annotations.Google_internal")
os.remove("/mnt/shell/0/emulated/Android/data/com.pubg.imobile/cache/GCloud.ini")
os.remove("/mnt/shell/0/emulated/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Logs")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/cache/GCloud.ini")
os.remove("/sdcard/Android/data/com.pubg.imobile/cache/GCloud.ini")
os.remove("/sdcard/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Logs")
...
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/cache/GCloud.ini")
os.remove("/sdcard/Android/data/com.pubg.imobile/cache/GCloud.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate/SaveGames/JKGuestRegisterCnt.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/AntiCheat.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/AppBaseConfig.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/AppConfig.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/AudioPluginConfig.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/BuildConfig.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/CustomDeviceList.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/DeviceProfiles.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/DeviceSwitchers.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/EditorPerProjectUserSettings.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/Engine.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/Game.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/Hardware.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/IGH5CachePluginConfig.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/IMSDKConfig.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/Input.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/LogSuppression.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/MidasConfig.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/OBHttp.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/OpenIDCommand.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/PufferDownloader.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/Scalability.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/ServerSwitch.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/UAE.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/Updater.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/UserCustom.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/UserSettings.ini")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Pandora/dns.txt")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/CommonSaveGame_4126599880770857.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/LeagueStatue.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/loginInfoFile.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/MailPhoneLogin.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/personalprefs_4123188938540329.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/personalprefs_4126599880770857.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/playerprefs.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/RecruitFilterSetting_4123188938540329.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/RecruitFilterSetting_4126599880770857.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/TableDatas/business_res_download_priority_table_new")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/TableDatas/cadge_table")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/TableDatas/dubber_table_ext")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/TableDatas/easy_buy_cfg")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/TableDatas/mentor_award_table")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/TableDatas/mentor_task_table")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/TableDatas/new_level_task_cover_table")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/TableDatas/social_authorize_config")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/TableDatas/upgrade_parameter")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/UpdateInfo/apollo_loglist.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/UpdateInfo/apollo_uuid_define.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/login-identifier.txt")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/cacheFile.txt")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/TGPA/.tgpacloud")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate/SaveGames/JKGuestRegisterCnt.json")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Logs/FileUseTime.txt")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/PufferEifs0/puffer_res.eifs")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/PufferEifs1/puffer_res.eifs")
os.remove("/storage/emulated/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/LightData/LightData3036393187.ltz")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/databases/google_app_measurement.db")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/databases/google_app_measurement_local.db-journal")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/databases/bugly_db_")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/databases/__hs__db_support_key_values")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/app_crashrecord/1004")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/databases/__hs__db_key_values")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/tss_uts_c2.dat")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/TAPM_CM_AUDIT")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/mycpuinfo")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/tss_cs_stat2.dat")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/hawk_data_init")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/hawk_data")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/AppEventsLogger.persistedevents")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/apm_cc")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/AdjustIoPackageQueue")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/AdjustIoActivityState")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/.system_android_l2")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/tss_tmp/config2.xml.f0ee7c80")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/tss_tmp/config3.xml")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/tss_tmp/tdm_cache.dat")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/tss_tmp/tss_emu_c2.dat")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/tss_tmp/tss_lcp.dat")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/tss_tmp/tss_r_record.dat")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/tss_tmp/tss.ano2.dat")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/files/tss_tmp/")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/databases/google_app_measurement.db")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/databases/google_app_measurement_local.db-journal")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/databases/bugly_db_")
os.remove("/data/user/0/com.tencent.mobileqqbiswa/data/data/user/0/com.pubg.imobile/databases/__hs__db_support_key_values")
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("17180003842", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.processResume()
revert = gg.getResults(100000, nil, nil, nil, nil, nil, nil, nil, nil)
gg.editAll("-7299045921596112383", gg.TYPE_QWORD)

gg.clearResults()
gg.searchNumber("2314850225648439042", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1, 0)
revert = gg.getResults(100000, nil, nil, nil, nil, nil, nil, nil, nil)
gg.editAll("67109377", gg.TYPE_QWORD)
...
gg.clearResults()
gg.getRangesList(":com.pubg.krmobile")
gg.sleep(300)
gg.toast("●▬▬▬▬▬▬▬▬▬▬▬▬● \n 🛡️ 3ᖇᗪ ᖴI᙭ ᗩᑕIᒪᗪI \n ☺ ️ᑎO ᗷᗩᑎ \n ●▬▬▬▬▬▬▬▬▬▬▬▬●")
end

function logcleaners()
os.remove("/storage/emulated/0/tencent")
os.remove("/storage/emulated/0/MidasOverse")
os.remove("/storage/emulated/0/Android/data/com.tencent.ig/files/tbslog")
os.remove("/storage/emulated/0/Android/data/com.tencent.ig/files/login-identifier.txt")
...
gg.toast("📋 İnternet Bağlantın Gitti..")
gg.editAll("220676386071773185", gg.TYPE_QWORD)
gg.sleep(2250)
gg.clearResults()
gg.toast("📋 İnternet Bağlantın Geldi")
end
...
function WMP10()
  ...
  gg.addListItems(var)
  gg.clearResults()
gg.toast("WallHack Ve Renk Açıldı")
end
...
WALL13 = gg.multiChoice({
    ...
    "🐘KIRIN 970 WallHack \n",
      ...
      if WALL13[1] == true then
      KIRIN650()
    end
    if WALL13[2] == true then
      KIRIN655()
    end
    if WALL13[3] == true then
      KIRIN658()
    end
    if WALL13[4] == true then
      KIRIN710()
    end
    if WALL13[5] == true then
      KIRIN970()
    end
    if WALL13[6] == true then
      CKW()
    end
    if WALL13[7] == true then
      CKY()
    end
    if WALL13[8] == true then
      CMG()
    end
    if WALL13[9] == true then
      CMR()
    end
    if WALL13[10] == true then
     DUVAR()
     end
     ABG = -1
     end
...
gg.toast("WallHack Ve Renk KIRIN 650 Açıldı")
end
...
gg.toast("WallHack Ve Renk KIRIN 658 Açıldı")
end
...
gg.toast("WallHack Ve Renk KIRIN 710 Açıldı")
end
...
function KIRIN970()
  ...
  gg.editAll("38", gg.TYPE_DWORD)
  gg.clearResults()
  gg.toast("WallHack Ve Renk KIRIN 970 Açıldı")
end



function exynos()
WALL12 = gg.multiChoice({
   ...
   if WALL12 == nil then
       ...
       if WALL12[1] == true then
      WE7420()
    end
    if WALL12[2] == true then
      WE7570()
    end
    if WALL12[3] == true then
      WE7870()
    end
    if WALL12[4] == true then
      CEW()
    end
    if WALL12[5] == true then
      CKG()
    end
    if WALL12[6] == true then
      CKR()
    end        
    if WALL12[7] == true then
      DUVAR()
      end
      end
      ABG = -1
...
function WE7420()
  ...
  gg.processResume()
  gg.toast("WallHack Ve Renk EXYNOS 7420 Açıldı")
end
...
function WE7570()
  ...
  gg.toast("WallHack Ve Renk EXYNOS 7570 Açıldı")
end
...
function WE7870()
  ...
  gg.toast("WallHack Ve Renk EXYNOS 7870 Açıldı")
end    
...
function SILAH()
    ...
    mal()
     ...
     if silahhack1[11] == true then
    rec()
    end
     if silahhack1[12] == true then
    lessrecoil()
    end     
     if silahhack1[13] == true then
    mermiha()
    end
     if silahhack1[14] == true then
      HOME()
    end
end
    ABG = -1
...
gg.editAll("699", 16)
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)gg.searchNumber("16000~99999;3D;0.1;1D::40", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
...
gg.getResults(900)
gg.editAll("691", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast(" ❌ Hasar Efekti Yenilendi")
end
...
gg["clearResults"]()
gg["toast"]("İleri Uzayan Kol")
else
  stand1 = off
gg.clearResults()
gg.setValues(sta_value0)
gg.clearResults()
gg.toast("İleri Uzayan Kol Kapandı")
  end
end
...
gg.clearResults()
    gg.toast("Sıt Scope On")
gg.toast(" Yukarı Uzanan Kol ")
else
  yukar1 = off
    gg.clearResults()
gg.setValues(sitscoppps1)
gg.clearResults()
    gg.toast("Yukarı Uzayan Kol Kapandı")
end
end
...
gg.editAll("0", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("Small Croshair Yenilendi")
end
...
gg.editAll("0", gg.TYPE_DWORD)
gg.clearResults()
gg.toast("Less Recoil Yenilendi")
end
...
gg.editAll("0", gg["TYPE_DWORD"])
gg.clearResults()
gg.toast("🔫 Hızlı Mermi Yenilendi🔫")
end                        
                            
                                
function OYUN(...)
  oyunhack1 = gg.multiChoice({
    "᚛📡᚜ Anten\n╚❑[Oʏᴜɴ]",
    "᚛👤᚜ İpad Modu\n╚❑[Oʏᴜɴ]",
    "᚛☀️᚜ Bsn İpad Modu\n╚❑[Oʏᴜɴ]",   
    "᚛🌫️️᚜ Sis Kaldır\n╚❑[Oʏᴜɴ]",       
    ...
    "᚛🧿᚜ Hızlı Paraşüt \n╚❑[Oʏᴜɴ]",   
    "᚛🔙᚜ Geri"
  }, nil, "Oyun Hilesi Menü Vip Farkı")
  if oyunhack1 == nil then
  else
    if oyunhack1[1] == true then 
    anten() 
    end
    if oyunhack1[2] == true then 
    ipad() 
    end
    if oyunhack1[3] == true then 
    ipadbsn() 
    end    
    if oyunhack1[4] == true then
    siskalk()
    end
    if oyunhack1[5] == true then
    cimen()
    end
    if oyunhack1[6] == true then
    blacksky()
    end
    if oyunhack1[7] == true then
    fastlan()
    end
    if oyunhack1[8] == true then
     HOME()
    end
end
    ABG = -1
...
fogvalue0 = gg.getResults(500)
gg.editAll("0", gg.TYPE_BYTE)
gg.toast("Fog Kaldırma")
gg.clearResults()
end
...
kos = off
function HIZ()
gg.toast("Abg Diyenler İçin Menü Abgnin")
...
gg.clearResults()
gg.toast("💨Dacia Hız Aktif Edildi!")
end
...
Flash3 = gg.getResults(100)
gg.getResults(1401)
gg.editAll("-1,328,550,408,576,460,390", gg.TYPE_QWORD)
gg.clearResults()
gg.searchNumber("-1505254313802431360", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
Flash4 = gg.getResults(100)
gg.getResults(1401)
gg.editAll("-1505254313804899999", gg.TYPE_QWORD)
gg.clearResults()
gg.setRanges(gg.REGION_CODE_APP)
gg.searchNumber("-1296744149883614555", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
Flash5 = gg.getResults(100)
gg.getResults(1401)
...
if safem1arab == nil then
else
if safem1arab[1] == true then
safeanten()
end
if safem1arab[2] == true then
safehs()
end
if safem1arab[3] == true then
safeless()
end
if safem1arab[4] == true then
safeipad()
end
if safem1arab[5] == true then
HOME()
end
end
ABG = -1
...
function safehs()
if safehs_check == off then
safehs_check = on
    gg.setRanges(gg.REGION_ANONYMOUS)
    gg.searchNumber("23;25;30.5", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
    gg.searchNumber("25;30.5", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
hs = gg.getResults(100)
...
gg.setValues(hb)
gg.clearResults()
gg.toast("❎ Headshot %90 devredışı ")
end
end

function safeless()
if safeless_check == off then
safeless_check = on
    gg.setRanges(gg.REGION_C_DATA)
    gg.searchNumber("-2.2673448e24;-1.36203639e28", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
    gg.refineNumber("-1.36203639e28", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
ahj = gg.getResults(99)
    gg.editAll("0", gg.TYPE_FLOAT)
    gg.clearResults()
    gg.setRanges(gg.REGION_C_DATA)
    gg.searchNumber("-309056968;-298841599;-309061065", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
    gg.refineNumber("-298841599", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
ahb = gg.getResults(5)
    gg.editAll("0", gg.TYPE_DWORD)
    gg.clearResults()
else
...
gg.setValues(ahb)
gg.clearResults()
gg.toast("❎ Less Recoil %90 ")
end
end

function safeipad()
if safeipad_check == off then
safeipad_check = on
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
gg.searchNumber("2.8025969e-45;220;25;178;15;100", gg["TYPE_FLOAT"], false, gg["SIGN_EQUAL"], 0, -1)
...
safeipad_check = off
gg.clearResults()
gg.setValues(safeipadvalue0)
gg.clearResults()
gg.toast("❎ IPad Modu Devredışı")
end
end

function safeanten()
if safeanten_check == off then
safeanten_check = on
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
gg.searchNumber("88.50576019287F;87.27782440186F;-100.91194152832F;1F::13", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
...
function EGLENCE(...)
  oyunhac = gg.multiChoice({
    ...
    "᚛〽️᚜ Scop Menü\n╚❑[Oʏᴜɴ]",   
    '【↪️】Geri',
  }, nil, "Eğlence Hilesi Menü")
  if oyunhac == nil then
  else
    if oyunhac[1] == true then
     ARABAUC()
     end
    if oyunhac[2] == true then
     FASTLAND()
     end
    if oyunhac[3] == true then
    trac()
    end
    if oyunhac[4] == true then 
    BULLETT() 
    end
    if oyunhac[5] == true then
    ANTIFALL()
    end
    if oyunhac[6] == true then
    SKYJUMP()
    end
    if oyunhac[7] == true then
    one()
    end
    if oyunhac[8] == true then
    yupp()
    end
    if oyunhac[9] == true then
    OTOMAT()
    end
    if oyunhac[10] == true then
    scopmn()
    end
    if oyunhac[11] == true then
     HOME()
    end
end
    ABG = -1
...
zoomx15 = off
function scopmn()
  SCOP2N =  gg.multiChoice({
    "᚛🕊️᚜ Scop 4x\n╚❑[Oʏᴜɴ]",
    "᚛🔫᚜ Scop 8x\n╚❑[Oʏᴜɴ]",
    "᚛🚀᚜ Scop 15x\n╚❑[Oʏᴜɴ]",
    "᚛🔙᚜ Geri"
  }, nil, "Scop Hilesi Menü")
  if SCOP2N == nil then
  else
    if SCOP2N[1] == true then 
    ZOOM4() 
    end
    if SCOP2N[2] == true then
    ZOOM8()
    end
    if SCOP2N[3] == true then
    ZOOM15()
    end
    if SCOP2N[4] == true then
    HOME()
    end
end
    ABG = -1
...
function CLOSED()
print("Vip Kullandığınız İçin Teşekkürler")
return os.exit()
end
 while true do
  Time = os.date("Haylos")
